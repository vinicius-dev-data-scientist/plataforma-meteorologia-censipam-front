...
# leitura da URL (vem depois e pode sobrescrever)
...
if st.session_state.page == "merge_climatologia":
    # =========================
    # TÍTULO
    # =========================
    st.markdown("""
...
elif st.session_state.page == "merge_diario":
    st.title("Merge CPTEC Diário")