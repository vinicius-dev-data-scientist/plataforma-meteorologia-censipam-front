    ...
    with st.container(border=True):
        ...
        with col_d:
            ...
            if loop == "Por período":
                ...
                st.caption(
                    f"""
                    Loop de {idx_inicio} UTC até {idx_fim} UTC —
            ...
            # =====================================================
                ...
                st.caption(
                    f"""
                    Loop de {opcoes[-n_fig_fix]} UTC até {opcoes[-1]} UTC —
                    {n_selecionadas} de {n_total} imagens
                    """
                )
...
<script>
    ...
    // =====================================================
    // ADICIONADO: QUADRADO DE DELIMITAÇÃO DA ÁREA (Retângulo Vermelho)
    // =====================================================
    L.rectangle(bounds, {{
        color: "red",
        weight: 2,
